...
namespace Cenfotur.Data.Migrations
{
    ...
    [Migration("20230506054850_AddNewColumnsOnNotasTable")]
    partial class AddNewColumnsOnNotasTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cenfotur.Entidad.DTOS.Output.DataSP_O_DTO", b =>
                {
                    b.Property<string>("Encuesta1")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("1");

                    b.Property<string>("Encuesta2")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("2");
                    ...
                    b.ToTable("DataSpODtos");
                });

            modelBuilder.Entity("Cenfotur.Entidad.DTOS.Output.DataSP2_O_DTO", b =>
                {
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.CursoPerfilRelacionado", b =>
                {
                    b.Property<int>("CursoId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CursoId", "PerfilRelacionadoId");

                    b.HasIndex("PerfilRelacionadoId");

                    b.ToTable("CursoPerfilRelacionado");
                });
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.Nota", b =>
                {
                    ...
                    b.Property<string>("Ep1")
                        .HasColumnType("varchar(20)")
                        .HasColumnName("EP1");

                    b.Property<string>("Ep2")
                        .HasColumnType("varchar(20)")
                        .HasColumnName("EP2");

                    b.Property<string>("Ep3")
                        .HasColumnType("varchar(20)")
                        .HasColumnName("EP3");

                    b.Property<string>("Ep4")
                        .HasColumnType("varchar(20)")
                        .HasColumnName("EP4");

                    b.Property<string>("Ep5")
                        .HasColumnType("varchar(20)")
                        .HasColumnName("EP5");
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.ParticipantePerfilRelacionado", b =>
                {
                    b.Property<int>("ParticipanteId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ParticipanteId", "PerfilRelacionadoId");

                    b.HasIndex("PerfilRelacionadoId");

                    b.ToTable("ParticipantePerfilRelacionado");
                });
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.CursoPerfilRelacionado", b =>
                {
                    b.HasOne("Cenfotur.Entidad.Models.Curso", "Curso")
                        .WithMany("CursoPerfilRelacionado")
                        .HasForeignKey("CursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.ParticipantePerfilRelacionado", b =>
                {
                    b.HasOne("Cenfotur.Entidad.Models.Participante", "Participante")
                        .WithMany("ParticipantePerfilRelacionado")
                        .HasForeignKey("ParticipanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.Curso", b =>
                {
                    b.Navigation("CursoPerfilRelacionado");
                });
            ...
            modelBuilder.Entity("Cenfotur.Entidad.Models.Participante", b =>
                {
                    ...
                    b.Navigation("ParticipantePerfilRelacionado");
                });
